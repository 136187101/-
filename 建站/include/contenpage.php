    ...
    function Pagination($total, $per, $page)
     {
			 ...
			 //if($purlw=="")
			 $pura=strstr($purl,"&page");
			 if($pura)
			 {
             $len=strlen($pura);
			 $purl=substr($purl,0,-7);
			 }
...
return $menu;
             ...
             else
             {
                         ...
                         if($page==1)
                         {
                           /*如果为第一页，直接从第二页链接开始输出*/
                               $menu.= "<B>[$page]</B>&nbsp;";
                               for ($page=2;$page<=$endcount;$page++)   $menu.= "<a href=\"{$purl}{$query_string}&amp;page={$page}\" class=link02><B>[$page]</B></a>   ";
                               $menu.= "&nbsp;<a href=\"{$purl}{$query_string}&amp;page=".$next."\" class=link02><B>下一页</B></a>&nbsp;&nbsp;<a href=\"{$purl}&{$query_string}&amp;page=".$allpage."\" class=link02><B>末页</B></a>";  
return $menu;
                         }
                         elseif($page==$allpage)
                         {

                               $menu.="   <a href=\"{$purl}{$query_string}&amp;page=1\" class=link02><B>首页</B></a>
                                       <a href=\"{$purl}&{$query_string}&amp;page=".$pre."\" class=link02><B>上一页</B></a>&nbsp;&nbsp;";
                               for ($page=$startcount0;$page<=$endcount0;$page++)   $menu.="<a href=\"{$purl}{$query_string}&amp;page={$page}\" class=link02><U><B>[$page]</B></U></a>   "; //后面3页
                               $menu.="<B>[$allpage]</B>";  
return $menu;
                         ...
                         {
                                     $menu.="   <a href=\"{$purl}{$query_string}&amp;page=1\" class=link02><B>首页</B></a>&nbsp;&nbsp;<a href=\"{$purl}{$query_string}&amp;page=".$pre."\" class=link02><B>上一页</B></a>&nbsp;&nbsp;"; 

                                   for ($page=$startcount0;$page<=$endcount0;$page++)  
   $menu.="<a href=\"{$purl}{$query_string}&amp;page={$page}\" class=link02><B>[$page]</B></a>&nbsp;";     //前面3页输出
                                   $menu.="<B>[$page]</B>&nbsp;";
                                   for ($page=$startcount;$page<=$endcount;$page++)  
   $menu.="<a href=\"{$purl}{$query_string}&amp;page={$page}\" class=link02><U><B>[$page]</B></U></a>&nbsp;"; //后面3页
...
function con_page($content){
	$content1 = arPagination($content,$_GET['page']);
	return  $content1;
	}
?>