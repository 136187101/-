...
$sql = "select * from jiaodian order by px asc";
$pagepre = 8;
$num=$db->setQuery($sql);
      ...
      <tr>
        <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="48%"><strong><span style="background:url(tpl/images/th_bg.gif);  padding-left:10px; border:none;"><a href="poster_tj.php">添加焦点图片</a></span></strong></td>
