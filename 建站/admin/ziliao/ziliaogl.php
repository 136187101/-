...
$sql = "select * from ziliao where fuid ='$fuid' order by sort desc";
$pagepre = 8;
$num=$db->setQuery($sql);
...
if($act == "del"){
$sql = "delete from ziliao where id = $id";

$db->query($sql);
$js->goto("?PB_page=$PB_page&fuid={$fuid}");
}
      ...
      <tr>
        <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="48%"><strong><span style="background:url(tpl/images/th_bg.gif);  padding-left:10px; border:none;">
              <a href="#"><?php echo $rs_zl[title]?></a></span>&nbsp;-&nbsp;<a href="addzl.php?fuid=<?php echo $fuid;?>">添加</a></strong></td>
              <td width="50%" align="right"><span class="STYLE3">你当前的位置</span>：[<?php echo $rs_zl[title]?>]
                资料管理</td>
            </tr>
        </table></td>
      </tr>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
          ...
          <tr>
            ...
            <td align="center" bgcolor="#FFFFFF"><?=$rs[times];?></td>
            <td align="center" bgcolor="#FFFFFF"><?=$rs["sort"]?></td>
            <td height="20" align="center" bgcolor="#FFFFFF">
                    <a href="upzl.php?act=edit&amp;id=<?=$rs[id]?>&amp;PB_page=<?=$_GET["PB_page"];?>&fuid=<?php echo $fuid?>">编辑</a>&nbsp; &nbsp;
                    <a href="?act=del&amp;id=<?=$rs[id]?>&PB_page=<?=$_GET["PB_page"];?>&fuid=<?php echo $fuid?>" onclick="return ConfirmDelBig();">删除</a></td>
          </tr>
          <?php 
		   $i++;
		   }
