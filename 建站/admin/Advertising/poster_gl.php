      ...
      <tr>
        <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="48%"><strong><span style="background:url(tpl/images/th_bg.gif);  padding-left:10px; border:none;"><a href="poster_tj.php">添加广告图片</a></span></strong></td>
              <td width="50%" align="right"><span class="STYLE3">你当前的位置</span>：[评论管理]
                <?=$row_zilei?></td>
            </tr>
        </table></td>
      </tr>
    ...
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
          <tr>
            <td width="5%" height="22" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">序号</td>
          <td width="11%" height="22" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">logo图</td>
            <td width="14%" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">连接地址</td>
            <td width="51%" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">位置</td>
            <td width="9%" height="22" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">时间</td>
            <td width="10%" height="22" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">基本操作</td>
          </tr>
          <?php 
		  $i=1;
		  foreach($jian as $rs){
          ...
          <tr>
            ...
            <td height="20" align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;<?=$rs[url]?></td>
            <td align="left" bgcolor="#FFFFFF"><?=$rs[weizhi]?></td>
            <td align="center" bgcolor="#FFFFFF"><?=date("Y-m-d",$rs[times]);?></td>
            <td height="20" align="center" bgcolor="#FFFFFF">
                    <a href="poster_up.php?act=edit&amp;id=<?=$rs[id]?>&PB_page=<?=$_GET["PB_page"];?>">编辑</a>&nbsp; &nbsp;
