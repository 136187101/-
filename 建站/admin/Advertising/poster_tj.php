...
if($Submit == "提交"){
			...
			$query = "INSERT INTO advertising(image,url,px,times,wide,high,weizhi)VALUES('$file1','$_POST[url]','$_POST[px]','".time()."','','','$_POST[weizhi]')";
			if($db->query($query)){
			$js->Alert("添加成功");
                ...
                <tr>
                  <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="95%"><span class="STYLE3">你当前的位置</span>：[广告管理]-[添加广告]</td>
                      </tr>
                  </table></td>
                  <td width="54%">&nbsp;</td>
                </tr>
