...
$mtime[] = array("<a href='http://www.v8v.com' target='_blank'><font color='#FFFF99'>中国同网</font></a> 全能ASP+PHP (2005-5-30)","138 毫秒","137 毫秒");
...
.aTitle {font-size: 12px; font-weight: bold; color: #414141; }
.input
{
...
.STYLE3{ font-weight:bold; color:#414141}
.STYLE4 {color: #414141}
-->
</style>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="5%"><div align="center"></td>
  ...
  <tr>
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="100%" align="center" cellpadding="2" cellspacing="0" class="aTable">
  <tr>
    <td width="164" align="left">PHP探针<br></td>
    <td width="588" align="right"><?=$ads?></td>
  </tr>
</table>
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="bTable">
  <tr>
    <td width="664" align="left"> 出现以下情况即表示您的空间不支持PHP： 1、访问本文件时提示下载。 2、访问本文件时看到类似“&lt;?php?&gt;”的文字。 </td>
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="aTable">
  <tr>
    <td colspan="2" align="left"><span class="aTitle"> ■函数支持情况检测:::... </span></td>
  </tr>
  <FORM action=<?=$_SERVER[PHP_SELF]?>#function method=post>
  <tr>
    <td width="80%" align="left" class="bTable">
	&nbsp;
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="aTable">
  <tr>
    <td colspan="2" align="left"><span class="aTitle"> ■邮件发送支持情况检测:::... </span></td>
  </tr>
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="aTable">
  ...
  <tr>
    <td width="80%" align="left" class="bTable">
	&nbsp;地址: 
	<input class=input type=text value="localhost" name="sql_host" size=10>
