...
class page_wlgr
{
	...
	function jks($canshu="")
	{
		...
		if($pageno!=1){
		echo "<a href=".$canshu."1.html class=\"pagenolinewlgr2\">首页</a>&nbsp;";
		echo "<a href=".$canshu.($pageno-1).".html class=\"pagenolinewlgr2\">上一页</a>&nbsp;";}
		for($n=$ks; $n<=$js;$n++)
		{
			if(strlen($n)==1){
				if($n==$pageno){echo "0".$n."&nbsp;&nbsp;";}else
				{echo "<a href=".$canshu.$n.".html class=\"pagenolinewlgr\">[0".$n."]</a>&nbsp;";}
			}
			else
			{
				if($n==$pageno){echo "".$n."&nbsp;&nbsp;";}else
				{echo "<a href=".$canshu.$n.".html class=\"pagenolinewlgr\">[".$n."]</a>&nbsp;";}
			}
		}
		if($pageno!=$totalpage){
		echo "<a href=".$canshu.($pageno+1).".html class=\"pagenolinewlgr2\">下一页</a>&nbsp;";
		echo "<a href=".$canshu.$totalpage.".html class=\"pagenolinewlgr2\">尾页</a>";}
		echo $this->ye();
