...
if($Submit == "提交"){
			...
			$query = "INSERT INTO advertising(image,url,px,times,wide,high,weizhi)VALUES('$file1','$_POST[url]','$_POST[px]','".time()."','0','0','$_POST[weizhi]')";
			if($db->query($query)){
			$js->Alert("添加成功");
...
<body>
<h1>
<span class="action-span"><a href="poster_gl.php">广告位列表</a></span>
<span class="action-span1">广告位管理</span><span id="search_id" class="action-span1"> - 添加广告位 </span>
    ...
    <table width="100%" id="general-table">
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td height="24" align="left" bgcolor="#FFFFFF"><textarea name="weizhi" cols="70" rows="3" id="weizhi"></textarea></td>
                </tr>
                <tr>
