...
$sql = "select * from ziliaofl order by px desc";
$pagepre = 8;
$num=$db->setQuery($sql);
...
if($act == "del"){
$sql = "delete from ziliaofl where id = $id";
      ...
      <tr>
        <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="48%"><strong><span style="background:url(tpl/images/th_bg.gif);  padding-left:10px; border:none;"><a href="addfl.php">添加资料分类</a></span></strong></td>
              <td width="50%" align="right"><span class="STYLE3">你当前的位置</span>：[<?php echo $rs_linkf["title"]?>]
                <?=$row_zilei?></td>
            </tr>
        </table></td>
      </tr>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
          ...
          <tr>
            ...
            <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;<a href="ziliaogl.php?fuid=<?php echo $rs[id]?>"><?=$rs[title]?>[点击进入]</a></td>
            <td align="center" bgcolor="#FFFFFF"><?=$rs[times];?></td>
            <td align="center" bgcolor="#FFFFFF"><?=$rs[px]?></td>
            <td height="20" align="center" bgcolor="#FFFFFF">
                    <a href="upfl.php?act=edit&amp;id=<?=$rs[id]?>&PB_page=<?=$_GET["PB_page"];?>">编辑</a>&nbsp; &nbsp;
