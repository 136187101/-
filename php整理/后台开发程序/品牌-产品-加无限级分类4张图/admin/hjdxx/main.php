...
body{text-align: center; margin: 0 auto; padding: 0;   background: #ebf9e1;font-size:12px;font-family:Tahoma, Arial}
...
table{clear:both;padding: 0; margin: 0 0 10px;border-collapse:collapse; border-spacing: 0;  border: 1px solid #c1d6b5;}

th{padding: 3px 6px; font-weight:bold;color:#000000;border:1px solid #cccccc; text-align:left;   line-height: 24px;
  background:url(images/lb_tbj_48.jpg) repeat-x;
  white-space: nowrap;}
...
td{padding: 3px 6px; border:1px solid #c1d6b5;}
