...
<body>
<h1>
<span class="action-span"><a href="poster_tj.php">添加焦点图</a></span>
<span class="action-span1">焦点图管理</span><span id="search_id" class="action-span1"> - 焦点图列表 </span>
...
<div class="list-div" id="listDiv">
  <table width="100%" cellpadding="3" cellspacing="1" id="listTable">
    ...
    <?php 
		   ...
		   ?>
    <tr>
      <td align="right" nowrap="nowrap" colspan="9"><!-- $Id: page.htm 14216 2008-03-10 02:27:21Z testyang $ -->
        <div id="turn-page">
