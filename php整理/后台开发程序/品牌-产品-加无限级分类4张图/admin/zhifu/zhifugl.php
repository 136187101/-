...
$sql = "select * from zhifu order by px desc";
$pagepre = 8;
$num=$db->setQuery($sql);
...
if($act == "del"){
$sql = "delete from zhifu where id = $id";
      ...
      <tr>
        <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="48%"><strong><span style="background:url(tpl/images/th_bg.gif);  padding-left:10px; border:none;"><a href="addzhifu.php">添加支付方式</a></span></strong></td>
              <td width="50%" align="right"><span class="STYLE3">你当前的位置</span>：[<strong><a href="link_tj.php">支付方式</a></strong>管理]
<?=$row_zilei?></td>
            </tr>
        </table></td>
      </tr>
    ...
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
          ...
          <td width="17%" height="22" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">开户行</td>
            <td width="23%" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">账号</td>
            <td width="15%" height="22" align="center" background="../images/bg.gif" bgcolor="#FFFFFF">收款人</td>
          ...
          <tr>
            ...
            <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;<?=$rs[yinhang]?></td>
            <td height="20" align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;<?=$rs[users]?></td>
            <td align="center" bgcolor="#FFFFFF"><?=$rs[name];?></td>
            <td align="center" bgcolor="#FFFFFF"><?=$rs[px]?></td>
            <td height="20" align="center" bgcolor="#FFFFFF">
                    <a href="upzhifu.php?act=edit&amp;id=<?=$rs[id]?>&amp;PB_page=<?=$_GET["PB_page"];?>">编辑</a>&nbsp; &nbsp;
