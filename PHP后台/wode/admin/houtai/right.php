...
<title>PHP探針 iProber V0.024 修改版</title>
<meta name="keywords" content="php探針,探針程式,php探針程式,探針,iProber,dEpoch Studio" />
<style type="text/css">
<!--
body,div,p,ul,form,h1 { margin:0px; padding:0px; }
body { background:#d3eaef; }
div,a,input { font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color:#000; }
div { margin-left:auto; margin-right:auto; width:720px; }
input { border: 1px solid #414340; background:#C0CFE4; }
...
table { clear:both; background:#93C1E3; border:3px solid #84ACB8; margin-bottom:10px; }
td,th { padding:4px; background:#d3eaef; }
th { background:#ACD4DE; color:#343525; text-align:left; }
...
#t3 td{ line-height:30px; height:30px; text-align:center; background:#204059; border:1px solid #BAD1E9; border-right:none; border-bottom:none; }
#t3 th,#t3 th a { font-weight:normal; }
#m4 td {text-align:center;}
.th2 th,.th3 { background:#868686; text-align:center; color:#000; font-weight:normal;  }
...
頁頭 
============================================================= -->
		<h1 style="display:none;"><i><b>i</b>Prober</i><span>V0.024</span></h1>
		<a name="top"></a>
		<p id="t12" style="display:none;">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0" id="t3" style=" margin-top:20px;">
			<tr>
