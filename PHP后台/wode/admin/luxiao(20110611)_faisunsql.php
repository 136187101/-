<?	error_reporting(1);	@set_time_limit(0);  if(!isset($_POST)){ $_POST = $HTTP_POST_VARS; $_GET = $HTTP_GET_VARS; $_SERVER = $HTTP_SERVER_VARS;}  ?>
	...
	<td style='padding-left:4px'  nowrap>64  KB</td>
</tr>
...
<tr class='tabledata' onmouseover='this.className="tabledata_on";' onmouseout='this.className="tabledata";'>
	...
	<td style='padding-left:4px'  nowrap>2011-06-12 06:46</td>
</tr>
<tr class='tabledata' onmouseover='this.className="tabledata_on";' onmouseout='this.className="tabledata";'>
...
create("rizhi"," (\n  `adminlogin_id` int(11) NOT NULL auto_increment COMMENT '日志ID',\n  `adminlogin_name` varchar(255) NOT NULL COMMENT '登陆管理员名称',\n  `adminlogin_ip` varchar(255) NOT NULL COMMENT '登陆IP',\n  `adminlogin_sj` varchar(255) NOT NULL COMMENT '登陆时间',\n  PRIMARY KEY  (`adminlogin_id`)\n) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8");

insert("('1','136187101','127.0.0.1','2011-06-12 13:45:18'),
('2','123','127.0.0.1','2011-06-12 13:45:31'),
('3','136187101','127.0.0.1','2011-06-12 13:45:39'),
('4','123','127.0.0.1','2011-06-12 13:47:21'),
('5','123','127.0.0.1','2011-06-12 14:29:46')");
