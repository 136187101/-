...
//<script language=javascript type="text/javascript"> 
	KE.show({
        ...
        items : [
        'undo', 'redo','justifyleft', 'justifycenter', 'justifyright', 'justifyfull', 'title', 'fontname', 'fontsize', 'textcolor', 'bgcolor', 'bold', 'italic', 'underline', 'strikethrough', 'link', 'unlink', 'removeformat', 'specialchar', 'emoticons', '-', 'image', 'flash', 'media', ]
    });
//</script>


//<textarea name="dibu" id="content7" ><?=stripslashes(输出内容时去掉反斜杠);?></textarea>
